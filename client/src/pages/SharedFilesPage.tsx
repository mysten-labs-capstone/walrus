    ...
    async (showSpinner = true) => {
      ...
      try {
        ...
        if (!response.ok) {
          ...
          console.error(
            "[SharedFilesPage] Response error:",
            response.status,
            text,
          );
          ...
          {files.length === 0 ? (
            <Card className="border-blue-200/50">
              <CardContent className="py-12 text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-500">
                  When someone shares a file with you, you can save it here for
                  easy access
                </p>
              </CardContent>
            </Card>
            ...
            <div className="grid gap-4">
              {files.map((file) => (
                <Card
                  key={file.id}
                  className="border-blue-200/50 hover:shadow-md transition-shadow"
                >
