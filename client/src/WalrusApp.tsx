      ...
      <div className="min-h-screen bg-slate-900 text-white flex items-center justify-center">
        <div className="bg-slate-800 p-8 rounded-lg shadow-lg text-center">
          ...
          <p className="text-slate-400 mb-6">
            Secure, decentralized file storage on Sui.
          </p>
          <ConnectButton />
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto">
        <header className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-3">
            <a href="/" className="flex items-center gap-3">
              <img src="/logo.png" alt="Walrus Logo" className="h-8 w-auto" />
              <span className="text-3xl font-bold">Walrus</span>
            </a>
          </div>
          <ConnectButton />
        </header>
        ...
        <Tabs defaultValue="upload" className="w-full">
          ...
          <TabsContent value="upload">
            <div
              className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-slate-700 p-12 text-center mt-6"
              {...getRootProps()}
            >
              <input {...getInputProps()} />
            ...
            {uploading && (
              <p className="mt-4 text-center text-slate-400">
                Uploading... Please approve transactions in your wallet.
              </p>
            )}
          </TabsContent>
                ...
                <ul className="space-y-4">
                  {uploadedFiles.map((file, idx) => (
                    ...
                    >
                      ...
                      <Button
                        onClick={() => downloadFile(file.blobId)}
